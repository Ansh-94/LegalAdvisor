...
<head>
    ...
    <title>Indian Evidence Act, 1872</title>
...
<body class="bg-purple-100 flex items-center justify-center min-h-screen p-5">
    ...
    <div class="container mx-auto">
        <h1 class="text-2xl font-bold text-center mt-5 mb-6">Indian Evidence Act, 1872</h1>
        <div id="data-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"></div>
    </div>

    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch("iea.json") // Replace with actual JSON file if using locally
