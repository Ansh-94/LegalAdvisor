...
<body class="bg-purple-100  bg-cover bg-center w-full">
    ...
    <div
        ...
        <div class="text-white max-w-lg w-full">
            ...
            <ul class="space-y-3">
                <li class="flex items-center gap-2 hover:text-yellow-300 transition-colors duration-300">
                    ✅ Right to Equality: Protection against discrimination based on race, gender, religion, or social
                    status.
                </li>
                <li class="flex items-center gap-2 hover:text-yellow-300 transition-colors duration-300">
        ...
        <div class="chatbot">
            <div class="chatbot-header">
                <div class="header-content">
                    <img src="https://cdn-icons-png.flaticon.com/512/4712/4712027.png" alt="Robot Logo"
                        class="robot-icon">
