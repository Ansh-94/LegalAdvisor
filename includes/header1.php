...
<body class="bg-purple-100  bg-cover bg-center w-full">
    ...
    <header class="bg-white bg shadow-md p-4 flex justify-between items-center ">
        <h1 class="text-xl font-bold text-purple-700 flex items-center space-x-2">
            <a href="/LegalAdvisor/index.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
        ...
        <nav class="hidden md:flex space-x-6">
            ...
            <a href="/LegalAdvisor/chatbot.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
            ...
            <a href="/LegalAdvisor/lawyerDirectory.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
            ...
            <?php if (isset($_SESSION['user'])) { ?>
                ...
                <a href="/LegalAdvisor/logout.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
 text-purple-700 font-bold hover:text-purple-900 
  hover:bg-purple-200">
            ...
            <?php } else { ?>
                <a href="/LegalAdvisor/log.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
 text-purple-700 font-bold hover:text-purple-900 
  hover:bg-purple-200">
                    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet" />
    ...
    <div id="moreSidebar"
        ...
        <ul class="mt-4 space-y-4">
            <li><a href="/LegalAdvisor/AboutUs.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
                  hover:bg-purple-500 gap-3 "><span class="material-symbols-outlined">
                        info</span>About Us</a></li>
            <li><a href="/LegalAdvisor/contactus.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
                  hover:bg-purple-500 gap-3"><span class="material-symbols-outlined">
                        call</span>Contact Us</a></li>
            <li><a href="/LegalAdvisor/LawsRules.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
                  hover:bg-purple-500 gap-3"><span class="material-symbols-outlined">
            ...
            <li><a href="/LegalAdvisor/faq.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                            text-purple-700 font-bold hover:text-purple-900 
                             hover:bg-purple-500 gap-3"><span class="material-symbols-outlined">
                        contact_support
                    </span>FAQ</a></li>
    ...
    <div id="sidebar"
        ...
        <ul class="mt-4 space-y-4">
            <li><a href="/LegalAdvisor/chatbot.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
                  hover:bg-purple-200 gap-3"><span class="material-symbols-outlined">chat</span>Get Legal Guidance</a>
            </li>
            <li><a href="/LegalAdvisor/lawyerDirectory.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
                  hover:bg-purple-200 gap-3"><span class="material-symbols-outlined">group</span>Lawyer Directory</a>
            </li>
            <li><a href="/LegalAdvisor/lawyerRegistration.php" class="flex items-center px-4 py-2 rounded-lg transition duration-300 
                 text-purple-700 font-bold hover:text-purple-900 
